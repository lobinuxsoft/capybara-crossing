...
namespace TMPro.Examples
{
    ...
    public class WarpText : MonoBehaviour
    {
        ...
        //private void OnValidate() => WarpText();

        //void Awake() => textComponent = gameObject.GetComponent<TMP_Text>();


        void Start() => Warp();

        public void Warp() => StartCoroutine(WarpTextRoutine());
