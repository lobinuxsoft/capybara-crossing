...
namespace AK
{
    namespace EVENTS
    {
        ...
        static const AkUniqueID PLAY_MENU_HOLD_TO_PLAY = 1149661472U;
        static const AkUniqueID PLAY_MENU_HOLD_TO_PLAY_REVERSE = 454546127U;
        static const AkUniqueID PLAY_MENU_HOVER_CLICK = 685607017U;
